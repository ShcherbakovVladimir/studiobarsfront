...
const getCodeStyles = (isDarkMode: boolean) => ({
...
const FormattedMessageBase: React.FC<{
  ...
  if (!isUser && isStreaming) {
    return (
      <ThinkingAwareContent
        ...
        answerClassName="whitespace-pre-wrap break-words leading-relaxed text-sm"
      />
    );
  }
  ...
  if (hasThinkingBlock && thinkingContent && thinkingContent.length > 0) {
    return (
        ...
        {answerContent && (
          <ReactMarkdown
            ...
            components={{
              ...
              thead({ children }) {
                return (
                  <thead className="bg-background/50 dark:bg-muted/50">
                    {children}
                  </thead>
                );
              },
              ...
              h3({ children }) {
                return (
                  <h3 className="text-lg font-bold my-2.5 text-blue-700 dark:text-blue-300">
                    {children}
                  </h3>
                );
              },
              ...
              h4({ children }) {
                return (
                  <h4 className="text-base font-semibold my-2 text-foreground">
                    {children}
                  </h4>
                );
              },
              ...
              img({ src, alt }) {
                ...
                return (
                  <div className="my-3">
                    ...
                    />
                    {alt && (
                      <p className="text-center text-xs text-muted-foreground mt-1.5">{alt}</p>
                    )}
                  </div>
                );
              },
              ...
              details({ children }) {
                return (
                  <details className="my-3 p-3 bg-background/50 dark:bg-muted/50 rounded-lg border border-border">
                    {children}
                  </details>
                );
              },
